...
export default function Home() {
  ...
  return (
    <div>
      <Head>
        <title>Xeramiya - UEBIT STRINGs</title>
        ...
        <article className="pt-2 pb-16 mx-1">
          <section className="">
            <div alt="Xeramiya">
              ...
              <span className="font-mono font-light text-lg italic ml-2">
                {stringName}
              </span>
            </div>
          </section>
