...
export default function Layout({ children }) {
  ...
  return (
    <div className="flex flex-col min-h-screen justify-between">
      ...
      <header className="fixed w-full h-11 py-3 backdrop-blur-md bg-gray/20 hover:backdrop-blur-xl active:bg-iRed text-nand-lighter">
        <nav className="mx-auto max-w-screen-md">
            ...
            <Link href="./">
              <a>
                ...
                <svg id="uebitLogoFace" width="100%" height="100%" viewBox="0 0 1967 492"
                  className="h-5 w-20 fill-nand-lighter hover:fill-white">
          ...
          <ul className="flex justify-end mx-1 text-center text-sm font-mono">
            <li>
              <Link href="/str3292">
                <a className="block w-16 sm:w-20 mx-1 rounded hover:bg-white/20 hover:text-white">
                  STr3292
                </a>
              </Link>
            </li>
